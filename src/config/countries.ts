 ...
 * For residency/citizenship selection in RateHawk API
 */
...
// Popular countries to show at top of lists
...
export function getCountriesWithPopularFirst(): Country[] {
  ...
  const otherCountries = COUNTRIES.filter(c => !popularCodes.has(c.code));
  return [...POPULAR_COUNTRIES, ...otherCountries];
}
