...
export const HotelPoliciesSection = React.forwardRef<HTMLElement, HotelPoliciesSectionProps>(
  function HotelPoliciesSection(
    { hotel, deposit = defaultDeposit, additionalBed = defaultAdditionalBed, pets = defaultPets },
    ref
  ) {
