...
export const StickyBookingBar = React.forwardRef<HTMLDivElement, StickyBookingBarProps>(
  function StickyBookingBar({ hotelId, hotelName, currency = "USD" }, ref) {
    ...
    return (
      <>
        <div ref={ref} className="fixed bottom-0 left-0 right-0 z-50 animate-fade-in">
