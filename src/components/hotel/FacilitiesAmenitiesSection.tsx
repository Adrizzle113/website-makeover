...
export const FacilitiesAmenitiesSection = React.forwardRef<HTMLElement, FacilitiesAmenitiesSectionProps>(
  function FacilitiesAmenitiesSection({ amenities }, ref) {
    ...
    return (
      <section ref={ref} className="py-10 bg-muted/20">
