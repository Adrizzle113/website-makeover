...
export function Header() {
  ...
  return <header className="absolute top-0 left-0 right-0 z-50 mt-4 md:mt-8 mx-[21px] md:mx-[37px]">
      <div className="container">
        ...
        {/* Mobile Menu */}
        {isMenuOpen && <div className="lg:hidden bg-primary/95 backdrop-blur-sm rounded-2xl p-6 mb-4">
            <nav className="flex flex-col gap-4">
              ...
              <button onClick={() => scrollToSection("contact")} className="text-white hover:text-cream transition-colors py-2 text-body-md text-left">
                Contact
              </button>
