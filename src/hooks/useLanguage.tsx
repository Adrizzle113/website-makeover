...
const translations: Record<Language, Record<string, string>> = {
  "en": {
    ...
    "register.placeholder.password": "Create a secure password",
    ...
    "forgotPassword.heroTitle1": "Reset Your",
    "forgotPassword.heroTitle2": "Password",
    "forgotPassword.heroDescription": "Don't worry, it happens to the best of us. Enter your email and we'll send you a reset link.",
    ...
    "forgotPassword.success.message": "We've sent a password reset link to your email. Please check your inbox and follow the instructions.",
    "forgotPassword.error.email": "Please enter a valid email address",
    "forgotPassword.error.failed": "Failed to send reset email. Please try again.",
    
    // Reset Password Page
    "resetPassword.heroTitle1": "Create New",
    "resetPassword.heroTitle2": "Password",
    "resetPassword.heroDescription": "Choose a strong password to keep your account secure.",
    ...
    "resetPassword.passwordHint": "At least 6 characters",
    "resetPassword.updatePassword": "Update Password",
    "resetPassword.updating": "Updating...",
    "resetPassword.success.title": "Password Updated!",
    "resetPassword.success.message": "Your password has been successfully updated. Redirecting to login...",
    "resetPassword.success.wait": "Please wait...",
    "resetPassword.success.loginMessage": "Password updated successfully! Please sign in with your new password.",
    "resetPassword.error.password": "Please enter a new password",
  ...
  "pt-BR": {
    ...
    "register.success": "Cadastro realizado com sucesso! Verifique seu e-mail para confirmar sua conta.",
    ...
    "register.placeholder.password": "Crie uma senha segura",
    "register.passwordHint": "Mínimo de 6 caracteres",
    "register.error.password": "A senha deve ter pelo menos 6 caracteres",
    ...
    // Forgot Password Page
    "forgotPassword.heroTitle1": "Redefinir Sua",
    "forgotPassword.heroTitle2": "Senha",
    "forgotPassword.heroDescription": "Não se preocupe, isso acontece com todo mundo. Digite seu e-mail e enviaremos um link de redefinição.",
    "forgotPassword.title": "Esqueceu a Senha",
    "forgotPassword.subtitle": "Digite seu e-mail para receber um link de redefinição",
    "forgotPassword.email": "Endereço de E-mail",
    "forgotPassword.emailPlaceholder": "Digite seu e-mail",
    "forgotPassword.sendLink": "Enviar Link",
    "forgotPassword.sending": "Enviando...",
    "forgotPassword.backToLogin": "Voltar ao login",
    "forgotPassword.rememberPassword": "Lembrou sua senha?",
    "forgotPassword.signIn": "Entrar",
    "forgotPassword.success.title": "Verifique Seu E-mail",
    "forgotPassword.success.message": "Enviamos um link de redefinição de senha para seu e-mail. Verifique sua caixa de entrada e siga as instruções.",
    "forgotPassword.error.email": "Por favor, insira um endereço de e-mail válido",
    "forgotPassword.error.failed": "Falha ao enviar e-mail de redefinição. Por favor, tente novamente.",
    
    // Reset Password Page
    "resetPassword.heroTitle1": "Criar Nova",
    "resetPassword.heroTitle2": "Senha",
    "resetPassword.heroDescription": "Escolha uma senha forte para manter sua conta segura.",
    ...
    "resetPassword.newPasswordPlaceholder": "Digite a nova senha",
    "resetPassword.confirmPassword": "Confirmar Senha",
    "resetPassword.confirmPasswordPlaceholder": "Confirme a nova senha",
    "resetPassword.passwordHint": "Pelo menos 6 caracteres",
    "resetPassword.updatePassword": "Atualizar Senha",
    "resetPassword.updating": "Atualizando...",
    "resetPassword.success.title": "Senha Atualizada!",
    "resetPassword.success.message": "Sua senha foi atualizada com sucesso. Redirecionando para o login...",
    "resetPassword.success.wait": "Por favor, aguarde...",
    "resetPassword.success.loginMessage": "Senha atualizada com sucesso! Por favor, entre com sua nova senha.",
    "resetPassword.error.password": "Por favor, digite uma nova senha",
