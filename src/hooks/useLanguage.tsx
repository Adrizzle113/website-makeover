...
const translations: Record<Language, Record<string, string>> = {
  "en": {
    ...
    "register.country.brazil": "Brazil",
    ...
    "verify.success.notification": "🎉 You'll receive an email notification once your account is approved.",
  ...
  "pt-BR": {
    ...
    "register.taxIdHintBrazil": "CPF (11 dígitos) para pessoa física ou CNPJ (14 dígitos) para empresas",
    "register.city": "Cidade",
    "register.country": "País",
    "register.country.brazil": "Brasil",
    ...
    "register.error.cpfCnpj": "Por favor, insira um CPF (11 dígitos) ou CNPJ (14 dígitos) válido",
    ...
    "verify.heroTitle2": "Lá!",
    "verify.heroDescription": "Enviamos um código de verificação para seu e-mail. Digite-o abaixo para concluir seu cadastro.",
    "verify.backToRegister": "Voltar ao cadastro",
    "verify.title": "Verifique Seu E-mail",
    "verify.sentCode": "Enviamos um código de 6 dígitos para",
    "verify.codeLabel": "Código de Verificação",
    "verify.codePlaceholder": "Digite o código de 6 dígitos",
    "verify.verifyButton": "Verificar E-mail",
    "verify.verifying": "Verificando...",
    "verify.didntReceive": "Não recebeu o código?",
    ...
    "verify.success.message": "Seu e-mail foi verificado com sucesso. Sua conta está agora em análise.",
    "verify.success.notification": "🎉 Você receberá uma notificação por e-mail assim que sua conta for aprovada.",
    "verify.success.redirect": "Redirecionando para página de status...",
    "verify.success.wait": "Por favor, aguarde...",
    "verify.error.invalidOtp": "Por favor, insira um código de 6 dígitos válido",
    "verify.error.incorrectCode": "O código inserido está incorreto. Por favor, tente novamente.",
    "verify.error.failed": "Falha na verificação. Por favor, tente novamente.",
    "verify.toast.success": "E-mail verificado com sucesso!",
    "verify.toast.resent": "Código enviado para seu e-mail",
    
    // Pending Approval Page
    "approval.heroTitle1": "Sua Jornada",
    "approval.heroTitle2": "Aguarda",
    "approval.heroDescription": "Estamos analisando sua aplicação para garantir a melhor experiência para todos os nossos parceiros de viagem.",
    ...
    "approval.approved.message": "Sua conta foi aprovada! Faça login para acessar seu painel.",
    "approval.rejected.title": "Aplicação Não Aprovada",
    "approval.rejected.subtitle": "Infelizmente, sua aplicação não foi aprovada. Entre em contato com o suporte para mais informações.",
    "approval.pending.title": "Conta em Análise",
    "approval.pending.subtitle": "Olá {name}! Sua conta está sendo analisada pela nossa equipe.",
    ...
    "approval.notVerified": "Não Verificado",
    ...
    "approval.step1": "Nossa equipe está analisando sua aplicação",
    "approval.step2": "Você receberá um e-mail assim que for aprovado",
    "approval.step3": "Esta página atualiza automaticamente",
